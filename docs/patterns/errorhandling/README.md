...
Option.monadError()
// arrow.instances.option.monadError.OptionMonadErrorInstanceKt$monadError$1@127f6358
```
...
Try.monadError()
// arrow.instances.try.monadError.TryMonadErrorInstanceKt$monadError$1@22d476a0
```
...
// arrow.instances.either.monadError.EitherMonadErrorInstanceKt$monadError$1@7ee9e50
```
