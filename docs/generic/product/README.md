...
// HCons(head=1000, tail=HCons(head=900, tail=arrow.generic.HNil@4df2d753))
```

```kotlin
Account(1000, 900).toHListLabeled()
// HCons(head=Tuple2(a=balance, b=1000), tail=HCons(head=Tuple2(a=available, b=900), tail=arrow.generic.HNil@4df2d753))
```
...
// DeferredK(deferred=LazyDeferredCoroutine{New}@4df90e21)
```
